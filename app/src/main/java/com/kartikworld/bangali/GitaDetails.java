...
public class GitaDetails extends AppCompatActivity {
    ...
    public static Bitmap GITA_BITMAP = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.gita_details);
        ...
        //******************************************************************************************
        textToSpeech = new TextToSpeech(GitaDetails.this, status -> {
        ...
        getSupportActionBar().setTitle(R.string.gita_back);
        ...
        if (GITA_BITMAP != null) imageCover.setImageBitmap(GITA_BITMAP);
        //******************************************************************************************
