...
public class WebBrowser extends AppCompatActivity {
    ...
    //int scale =50; //scale is percent of zoom level you want
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(""+WEBSITE_TITLE);
        ...
        webView.setFitsSystemWindows(true); // your preferences
        webView.setVerticalScrollBarEnabled(true); // your preferences
        ...
        //don't forget to add storage permission in your manifest  ******
        ...
        //Enable this if you want to add download feature with webView end//**
        //don't forget to add storage permission in your manifest end//**

        //ZoomIn
        /**
        try {
            Intent webView = new Intent(Intent.ACTION_VIEW, Uri.parse(WEBSITE_LINK));
            startActivity(webView);
        } catch (ActivityNotFoundException e) {
            Toast.makeText(WebBrowser.this, "No application can handle this request. Please install a web browser",  Toast.LENGTH_LONG).show();
            e.printStackTrace();
        }
        */
        webView.zoomIn();
