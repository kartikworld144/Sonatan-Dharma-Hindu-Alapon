...
import static com.kartikworld.bangali.MasterKartikYoutube.BUFFERING;
import static com.kartikworld.bangali.MasterKartikYoutube.CUED;
import static com.kartikworld.bangali.MasterKartikYoutube.ENDED;
import static com.kartikworld.bangali.MasterKartikYoutube.PAUSED;
import static com.kartikworld.bangali.MasterKartikYoutube.PLAYING;
import static com.kartikworld.bangali.MasterKartikYoutube.UNSTARTED;
...
public class My_Tube_Player extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {


    MasterKartikYoutube webYouTube;
    ...
    ImageView imgClosePlayer, imgPlayPause, imgPrevious, imgNext, mainCover, repeat_one;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //tvDate = findViewById(R.id.tvDate);
        ...
        imgClosePlayer = findViewById(R.id.imageClosePlayer);
        ...
        // Youtube thumbnail link is like
        //https://i.ytimg.com/vi/<VIDEO ID>/0.jpg
        String thumb_link = "https://i.ytimg.com/vi/"+video_id+"/0.jpg";
        Picasso.get().
                load(""+thumb_link)
            ...
            public void onClick(View v) {
                ...
                if (v!=null && v.getTag()!=null){
                    ...
                    if (tag.contains("PLAYING")){
                        ...
                        else Toast.makeText(My_Tube_Player.this, "Please wait...", Toast.LENGTH_LONG).show();
        ...
        repeat_one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!REPEAT_ONE){
                    REPEAT_ONE = true;
                    repeat_one.setBackgroundColor(Color.parseColor("#ffffff"));
                    repeat_one.setColorFilter( Color.parseColor("#000000"));
                    Toast.makeText(My_Tube_Player.this, "Repeat one enabled", Toast.LENGTH_SHORT).show();
                }else{
                    REPEAT_ONE = false;
                    repeat_one.setBackgroundColor(Color.TRANSPARENT);
    ...
    private void initMultiPlayers(){
        ...
        //Adding Master Kartik YouTube Player
        webYouTube = new MasterKartikYoutube(My_Tube_Player.this);
        layPlayerRoot.addView(webYouTube);
        webYouTube.setVisibility(View.GONE);
        webYouTube.initialize();
        setupMasterKartikYoutube();
        ...
        youTubeView.initialize("AB", My_Tube_Player.this);


        // Master Kartik Player listener handler
        setMasterPlayerListener();
    ...
    private void setMasterPlayerListener(){
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++
        webYouTube.setOnPlaybackStateChange(new Runnable() {
            ...
            public synchronized void run() {
                switch (webYouTube.getPlaybackState()) {
                    ...
                    case UNSTARTED:
                        //Toast.makeText(getApplicationContext(), "Un started : "+Service_Overlay.playerView.getPlaybackState(), Toast.LENGTH_LONG).show();
                        break;
                }
        ...
        webYouTube.setCurrentTimeListener(new MasterKartikYoutube.NumberReceivedListener() {
            @Override
            public void onReceive(float n) {
                currentSeconds = (int) n;
            }
        }); //TODO: Put this in player view itself
        webYouTube.setDurationListener(new MasterKartikYoutube.NumberReceivedListener() {
            @Override
            public void onReceive(float n) {
                videoDuration = (int) n;
            }
        }); //TODO: Put this in player view itself
        webYouTube.setVideoLoadedFractionListener(new MasterKartikYoutube.NumberReceivedListener() {
            @Override
            public void onReceive(float n) {
                videoBuffered = n;
            }
        ...
        //Update seekbar every second with handler // --
    ...
    public void setupMasterKartikYoutube() {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public MyAdapter(){
            this.inflater = (LayoutInflater) My_Tube_Player.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Animation animation = AnimationUtils.loadAnimation(My_Tube_Player.this, R.anim.splash_top);
            ...
            String vdo_description = hashMap.get("vdo_description");

            tvTitle.setText(vdo_title);
            tvDescription.setText(vdo_description);
    ...
    private void playVideo(String video_id){
        ...
        try{
            ...
            layPlayer.startAnimation(AnimationUtils.loadAnimation(My_Tube_Player.this, R.anim.fade_in));
            ...
            //Toast.makeText(My_Tube_Player.this, "Please wait..", Toast.LENGTH_LONG).show();
    ...
    private void playWithMasterJubaPlayer(String video_id){
        ...
        try{
            ...
            Toast.makeText(My_Tube_Player.this, "Please try again!", Toast.LENGTH_LONG).show();
        }
        playingVideo = true;
    ...
    private void playPreviousVideo(){
        if(PLAYING_NOW > 0){
            ...
            Toast.makeText(My_Tube_Player.this, "Playing the first video", Toast.LENGTH_LONG).show();
        }
    ...
    private void showYoutubeInstallDialog(){
        AlertDialog alertDialog = new AlertDialog.Builder(My_Tube_Player.this).create();
    ...
    //try to download app from app stores
