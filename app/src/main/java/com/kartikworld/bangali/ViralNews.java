...
public class ViralNews extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.viral_news);
        ...
        getSupportActionBar().setTitle("সম্প্রতিকালের ভাইরাল খবর");
        ...
        tryAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ViralNews.this, ViralNews.class);
                startActivity(intent);
                finish();
            }
        });
        //+++++++++++++++++++++++++++++++++++++++++++++++
        if(!isNetworkAvailable(ViralNews.this)){
        ...
        String url = "https://kartikworlddotcom.000webhostapp.com/apps/viral.json";
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ViralNews.this);
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            View myView = layoutInflater.inflate(R.layout.viral_news_item, null);


            //********************************************
            Animation animation = AnimationUtils.loadAnimation(ViralNews.this, R.anim.kartik_anim);
            animation.setStartOffset(i * 20);
            ...
            buttonDetails.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(ViralNews.this, NewsDetails.class));
                }
