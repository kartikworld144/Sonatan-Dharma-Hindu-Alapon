...
/**
 * Created by Kartik on 09-Aug-2022.
 * The main PlayerView that inherits a Web view, loads a custom specified HTML/CSS/JS code and provides callback and helper functions to control the video playback
 */

public class MasterKartikYoutube extends WebView {
	...
	public MasterKartikYoutube(Context context) {
		super(context);
	}

	public MasterKartikYoutube(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public MasterKartikYoutube(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
